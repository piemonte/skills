# Installing te-shader for Codex
...
cmd /c mklink /J "$env:USERPROFILE\.agents\skills\te-shader" "$env:USERPROFILE\.codex\piemonte-skills\te-shader"
```
