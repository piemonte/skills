# Installing te-pattern for Codex
...
cmd /c mklink /J "$env:USERPROFILE\.agents\skills\te-pattern" "$env:USERPROFILE\.codex\piemonte-skills\te-pattern"
```
